...
QaurtSmart 提供從行情接入到策略驗證的基礎能力。平台只負責統一介面、計算與展示；資料源、AI 服務及風控邏輯由部署者自行選擇與配置。
...
社群版不提供官方 AI 市場洞察、智慧研究、多分析師協作、AI 風險評估、授權資料聚合、訂閱支付及企業 SLA。社群版保留單一 AI 分析師入口，支援使用者配置自己的模型與提示詞。需要完整能力時，可瀏覽 [官方完整版](https://www.goldenaiquant.cn/)，或在自己的環境接入相應服務。
...
| Mock/CSV/自訂 Provider、單一 AI 分析師 | 智慧研究、多分析師協作與第三方聯網研究編排 |
| 使用者自訂風險規則與 AI 介面 | 官方 AI 風險評估、動態權重與推薦邏輯 |
| 單一 AI 分析師（一次一位、單輪） | 多分析師協作、多 Agent 編排、智能研究 |
